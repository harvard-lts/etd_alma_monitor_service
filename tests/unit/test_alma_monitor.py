...
class TestAlmaMonitor(unittest.TestCase):
    ...
    def test_poll_for_alma_submissions(self, MockMongoUtil):
        ...
        mock_mongo_util.query_records.return_value = [{'_id': '6545889182013d2d2b1a77c5', 'proquest_id': 1234567, 'school_alma_dropbox': 'gsd', 'alma_submission_status': 'ALMA_DROPBOX'}, {'_id': '6545889182013d2d2b1a77c6', 'proquest_id': 2345678, 'school_alma_dropbox': 'dce', 'alma_submission_status': 'ALMA'}]
